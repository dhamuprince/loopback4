...
export class TodoListTodoController {
  ...
  async find(
    ...
    return this.todoListRepository.todosfirst(id).find(filter);
  }
  ...
  async create(
    ...
    return this.todoListRepository.todosfirst(id).create(todo);
  }
  ...
  async patch(
    ...
    return this.todoListRepository.todosfirst(id).patch(todo, where);
  }
  ...
  async delete(
    ...
    return this.todoListRepository.todosfirst(id).delete(where);
  }
}
